// Unit test: ex_mem_flush — C++ harness with difftest
#include "Vtest_ex_mem_flush.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
    ...
    // difftest_step() calls exit(1) on mismatch, so we only reach here on
    // timeout (pipeline stalled / program ran out of cycles without error)
